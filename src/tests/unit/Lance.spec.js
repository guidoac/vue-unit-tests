...
describe("lance sem valor minimo", () => {
  ...
  test("emite um lance quando um valor é maior do que zero", () => {
    const wrapper = mount(Lance);
...
describe("lance com valor mínimo", () => {
  ...
  test("não são aceitos lances menores que o minimo informado", async () => {
    const wrapper = mount(Lance, {
      propsData: {
        lanceMinimo: 300
      }
